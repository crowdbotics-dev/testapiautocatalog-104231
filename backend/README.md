...
## Project Structure
    ...
    ├── testapiautocatalog_104231  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104231`
...
2. Clone this repo and `cd testapiautocatalog_104231`
